...
ALLOWED='^(ED301_HERMETIC_LAUNCH|ED301_SOURCE_MODE|ED301_VERIFIED_SNAPSHOT|ED301_EXPECTED_SOURCE_MANIFEST_SHA256|ED301_EXPECTED_GIT_COMMIT|ED301_MODULE_DIR|ED301_PROVIDER_CONTEXT_HARNESS|OPENSSL_PREFIX|OPENSSL_OBJECT_LISTS|X301_TLS_LONG_HANDSHAKES|X301_TLS_RESULT_ROOT|X301_CONTRACT_RESULT_ROOT|X301_FUZZ_TARGET_DIR|X301_FUZZ_CORPUS_DIR|X301_FUZZ_ARTIFACT_DIR|PATH|HOME|LC_ALL|PWD|SHLVL|_)='
