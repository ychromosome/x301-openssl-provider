...
| E2 | X301 is not a second field engine | RFC 7748 ladder pattern; frozen Ed301 5x64 field | Reuse existing `mul`, `square`, reduction and constant-time selection. A new reducer, representation or swap path is forbidden. |
...
| --- | --- | --- |
| A second X301 field module, reducer or conditional swap | Existing Ed301 5x64 field and constant-time selection | E2; duplicate arithmetic doubles the assurance surface. |
