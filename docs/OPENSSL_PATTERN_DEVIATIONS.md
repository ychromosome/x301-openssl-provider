...
| X-H1 | X301MLKEM1024 follows the X-family naming used by RFC 10024's `X25519MLKEM768` and OpenSSL's `X448MLKEM1024`. The name is the same historical-style exception: client share, server share and shared secret remain ML-KEM first. | The old `MLKEM1024X301` name is rejected; exact 1606/1606/70-byte layouts, 1605/1607 totals, and delete/insert mutations at offset 1568 are tested. |
