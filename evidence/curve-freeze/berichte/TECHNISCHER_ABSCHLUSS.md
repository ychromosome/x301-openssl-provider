...
> **HISTORISCHER ABSCHLUSSSTAND.** Die Kurvenbefunde bleiben als technische
> Evidenz erhalten. Aussagen zu `Ed301-Sig-v1` beschreiben dessen damaligen
> Stand; dieser Signaturentwurf ist inzwischen **retired / nonnormative** und
> weder Eingabe noch Fallback des aktuellen Ed301-EdDSA-Entwurfs. `X301-v1`
> ist ein getrenntes XDH-Verfahren außerhalb des aktiven Signaturreviews.
